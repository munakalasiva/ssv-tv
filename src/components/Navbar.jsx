...
function Navbar() {
  ...
  return (
    <nav className="bg-[#0A2540] shadow-md sticky top-0 z-50">
      ...
      {/* Mobile Dropdown */}
      {isOpen && (
        <div className="md:hidden bg-[#0A2540] border-t border-gray-700 absolute top-[80px] left-0 right-0 shadow-lg">
          <div className="px-6 pb-5 pt-2 flex flex-col space-y-3">
            ...
            <Link
              to="/booking"
              onClick={() => setIsOpen(false)}
              className="text-center w-full bg-[#E63946] text-white px-6 py-3 rounded-full font-semibold hover:bg-red-700 transition-all duration-300 mt-3"
            >
              Book a Repair
            </Link>
          </div>
